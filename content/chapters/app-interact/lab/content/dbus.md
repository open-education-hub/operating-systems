...
Run the script in `support/dbus/send_notification.sh`:
...
The method you need to call is `org.freedesktop.DBus.Properties.Get` from the `/org/freedesktop/UPower/devices/Display` object.
